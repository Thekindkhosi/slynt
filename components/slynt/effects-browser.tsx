      ...
      <div className="flex flex-col gap-3 border-b border-[var(--border-subtle)] px-3 py-3 sm:px-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="relative w-full md:w-56 xl:w-64">
          ...
          <input
            ...
            className="h-10 w-full rounded-[7px] border border-[var(--border)] bg-[var(--surface-secondary)] pl-9 pr-3 text-[13px] text-white outline-none transition placeholder:text-[var(--text-muted)] focus:border-white/70"
